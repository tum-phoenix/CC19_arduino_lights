...
volatile uint32_t command_start_times[5] = {0, 0, 0, 0, 0};
...
void ISR_function(void)
{
  ...
  {                                                     // falling edge means stop of signal
    ...
    {
      command_start_times[0] = cur_pwm_micros/1000;
    }
    if (((bitwise_command >> 1) & 1) && !((bitwise_command_prev >> 1) & 1))
    {
      command_start_times[1] = cur_pwm_micros/1000;
    }
    if (((bitwise_command >> 2) & 1) && !((bitwise_command_prev >> 2) & 1))
    {
      command_start_times[2] = cur_pwm_micros/1000;
    }
    if (((bitwise_command >> 3) & 1) && !((bitwise_command_prev >> 3) & 1))
    {
      command_start_times[3] = cur_pwm_micros/1000;
    }
    if (((bitwise_command >> 4) & 1) && !((bitwise_command_prev >> 4) & 1))
    {
      command_start_times[4] = cur_pwm_micros/1000;
    }
